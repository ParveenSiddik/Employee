...
urlpatterns = [
    ...
    path('employee/<int:pk>/remove',views.EmployeeDeleteView.as_view(),name="employee_delete"),
    path('employee/<int:pk>/change',views.EmployeeUpdateView.as_view(),name="employee_update")
]
